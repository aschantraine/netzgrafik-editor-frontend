...
## [2.12.0](https://github.com/aschantraine/netzgrafik-editor-frontend/compare/netzgrafik-editor-frontend-v2.11.1...netzgrafik-editor-frontend-v2.12.0) (2026-06-19)


### Features

* add port ordering algorithm to minimize crossings ([143a7a7](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/143a7a7daef9f2e63acd7820aa1fed157a41c40c))
* add strict Content-Security-Policy for standalone mode ([ea5611f](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/ea5611fb9d0e51f4235bb8e08db140a65e9ab936))
* display origin-destination matrix ([403b23b](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/403b23bf2c862444e7ad7c8e17fd3f94a9a4a97a))
* display origin-destination matrix ([09a43cd](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/09a43cdfc96038d88027aa74a8479886d3f4c25b))
* Drag drop reroute multi sections ([#633](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/633)) ([0f9e567](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/0f9e567980a898fa138b88378f3d08dcfee0e382))
* **editor-main-view:** add asymmetric trainrun filter ([6335012](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/633501254965b6383716005a741495a43611d32c))
* **editor-main-view:** add asymmetry arrow filter ([d31174d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/d31174d07f61b938bd17f49fb064d011c46a9f7e))
* **editor-main-view:** add backward travel time filter ([e7f7cee](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/e7f7cee4b31592a3f523fa450edf6eedb0800ad3))
* **editor-main-view:** display backward travel time ([9775e66](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/9775e661e7cf486852e9de1ceb724b45968dddc0))
* **editor-main-view:** introduce asymmetry arrow ([c820912](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/c820912f9f166334d9a1f2ac1279e783bef8cc7e))
* integrate new port ordering into UI ([#635](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/635)) ([87cf7cb](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/87cf7cb9396eeb428e8ef818fbb01597ff26e5a1))
* **models:** add helpers to Port and Transition ([a395aed](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/a395aed1edc845ded1cb6145a203c8ab7a07336d))
* **perlenkette:** add asymmetry support ([f8cace1](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/f8cace14b67259a2c2d44673b2afb2bd4d1fb6cb))
* **service:** emit on filterChanged() ([41b4416](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/41b441639839992879e8735fd76c901e592def10))
* **service:** emit operation when OrderingAlgorithm changed ([d0e0bac](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/d0e0bac44ac22abe8b433b518eb8319a381528c3))
* **services:** add asymmetry support to propagateTrainrunSectionTime() ([37c1ee5](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/37c1ee5c1db8367380e0e42c0c646b0cc0fc9276))
* **traffic-side:** add traffic side configuration in editor properties ([0287cc7](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/0287cc7833fe93a48e28d55fbf48a0efcc883bdb))
* **traffic-side:** update netzgrafik dto ([efca965](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/efca965a1b29bc8f49ed1fd1a385d2e7e416efb9))
* **traffic-side:** update traffic side in views ([336c4bc](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/336c4bcb22f78261bb58562db45afb9e643b7d73))
* **view:** add symmetry switches to section tab in trainrun dialog ([6a0cdff](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/6a0cdff55948bd18e8b58bf8e7f746dd18413e54))
* **view:** enable full name display instead of short name in editor-main-view ([36ba033](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/36ba0336d376ef5af88b9674024f259ae658f82f))
* **view:** enable full name display instead of short name in perlenkette ([2d7a897](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/2d7a8977ca29ddd41e7c757bfbaed99b4ad19393))
* **view:** enable full name display instead of short name in streckengrafik ([f3e2311](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/f3e2311a07d89f3eb9144ec0a19d9cde724e1e5d))
* **view:** enable full name display instead of short name od-matrix ([4cc9018](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/4cc9018965b2ee32bda58ddd9430f1e9f06b7cd1))
* **view:** hide note borders when no mouse over ([7609754](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/7609754f2bbe114417e6acc432a5004aff884bd4))


### Bug Fixes

* Add checks to ensure the trainrun section remains valid in edge cases. ([#793](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/793)) ([b62bb93](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/b62bb939666168d9cf94c9bcf4c4142cb97afb53))
* Add extra check for MultiNodeMoving trainrun section   ([#769](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/769)) ([5466655](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/54666558c33c8f2e0cde9b9453817acb9281112f))
* add missing event emitter to node service when duplicating node ([d855e65](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/d855e6510d982775f001fb555cd54afc51777c34))
* add missing source arrival in TrainrunSectionViewObject.generateKey() ([8fad923](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/8fad923a81129c60dcc08a4724878d7e08797401))
* adding strict null checks for app/data-structures directory ([#657](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/657)) ([b5e3dbb](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/b5e3dbbbb93b7df2110580de7b60863be96a2be3))
* address XSS vulnerability with note text ([27ba35c](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/27ba35c2d7b1238ebca275e64ad92d889889afd2))
* aemit operations for position transformation service ([#400](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/400)) ([a7dae9e](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/a7dae9ef2f71e32238c3015d1ae4165dfd0d7bf8))
* After pusblishing the netzgrafik-editor under the host of OpenRailAssocation there should no longer the old github url in the repo. ([#737](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/737)) ([c3997e6](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/c3997e682f8799a32577ad815e965160cf9dd1d6))
* Bug `saveSvgAsPng` exports incorrectly when Windows display scaling ≠ 100% fixed ([#563](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/563)) ([6b0dfe8](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/6b0dfe8dac3823389defe31b31afed48300bfddd))
* changed filtering oder and add cull for notes ([#429](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/429)) ([b863cda](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/b863cda2554e49c5fa6da4d4d53d1a10042eb1e4))
* check strict null from temporary config file instead of package.json ([3fce925](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/3fce9251536a9723b99633ac149ce03fa2536479))
* check was missing - the filtering should only be reset when a filter is active and the filtering is not temporary switched off ([#451](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/451)) ([1551417](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/1551417d79c3184db82593d84d6ac62f8c7eff95))
* Check/correct missing transition after combine two trainruns ([#767](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/767)) ([5a5e766](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/5a5e766f6d091f4517f17987cb53fae8686a58ac))
* **ci:** switch to actions/upload-pages-artifact for GitHub Pages ([c222d06](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/c222d06749e4e08a177290f5555485eaa53455cd))
* Clicking in the background in the Pearl view triggers stop editing ([#566](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/566)) ([6a9de5c](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/6a9de5c61a2a07aee14aee78dd64fff997a7ad09))
* compute leftToRight per trainrun in Streckengrafik ([#749](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/749)) ([f8469fa](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/f8469fa6c9901c1244a6bf1f23b92ff79bff5927))
* compute OD matrix for a full day ([#922](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/922)) ([6939bdd](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/6939bdd9e5d80a61c23faa9c2468f4607edb5d01))
* compute OD matrix for a full day ([#922](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/922)) ([6939bdd](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/6939bdd9e5d80a61c23faa9c2468f4607edb5d01))
* compute OD matrix for a full day ([#922](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/922)) ([f6e5f7e](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/f6e5f7e063f58604258d5f3eead01c5d235e4b8d))
* drop duplicate frequency in TrainrunSectionViewObject.generateKey() ([233b0f1](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/233b0f1c424b740e1c73e393fa594b19d16c06cd))
* drop extraneous "browser" directory in dist/ ([abd6127](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/abd6127903a7038d13b8ba5f7ffed8fd289d830d))
* drop favicon from standalone index.html ([d25f281](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/d25f281ef70a5b9260414b24940ecf344c44f3b7))
* **editor-main-view:** clear all objects when loading new DTO ([0e1265c](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/0e1265c15b03fe953319df39a533dd425463302f))
* emit single operation in setTimeStructureToTrainrunSections() ([7d85bee](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/7d85bee5e19417094be395b2720f383c5364c1b4))
* emit trainrun create after creating its sections when duplicating ([58d202e](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/58d202eed988772018deb0ac086194d7ea2b344c))
* emit trainrun create after creating its sections when duplicating ([31115a9](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/31115a93f69599c0caf665796679033792f02527))
* ensure both trainruns have endNodes at "pin" ([#862](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/862)) ([766463c](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/766463ce34c849e7e3d0d1e6a659a0ed0e8384a8))
* Ensure that only correct/valid (feasible) connections gets added ([#1025](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/1025)) ([3914bf6](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/3914bf661f7890146bac41358353583100fffeea))
* Ensure the SVG container uses the full - space ([#612](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/612)) ([616b8d2](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/616b8d2d2d29c750f757119eeff2b894e9974635))
* Entering a negative value causes incorrect departure/arrival times ([#780](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/780)) ([85fce12](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/85fce12b5268cda5f4dfcf6dc169cdbfeb03e7cf))
* Firefox rendering issue fixed – styling slightly changed ([#548](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/548)) ([d939b84](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/d939b84409fb6410f34da2227812aa8810f61605))
* fix metadata operation ([232f2a1](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/232f2a14f5a5f14ab0289432e7cc4466d38148fe))
* fix traffic side in editor view ([6ac83d6](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/6ac83d6a464e39ca8549570dd15b657446728f28))
* for downwards propagation the translation key was wrong ([#630](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/630)) ([46c293c](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/46c293c9c9ae49f1bba77511f0379b9ae54f43c7))
* Graphical Timetable (Streckengrafik) – Section Track Estimator Not Working for Train with direction changes ([#614](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/614)) ([a623d3f](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/a623d3f4cb29a62b48e48ce644d89243ed8c2de6))
* handle potential null values in app/view/themes directory ([1dfb0ac](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/1dfb0ac6987e60c05394a5008e2fdcd73e7cd596))
* Highlight entire trainrun when hovering a trainrun section line ([#534](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/534)) ([7785dea](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/7785dea05cc4781eca7cd091045ea2ccd5908a44))
* **i18n:** fix missing symmetry translation identifier ([04982f9](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/04982f9d59f368c63807f7fd24dff16ae69f1430))
* **i18n:** zoom out german typo ([158555f](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/158555f9d6c0174d3c4ce8830c480d2b2844ddf1))
* If there is in the data a epsilon issue, we just remove it at latest point to ensure the export and rendering looks good ([#622](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/622)) ([6e81f56](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/6e81f568da3b75b0f65194b5623778727649c9a6))
* implemented in such a way the ux expert proposed ([#991](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/991)) ([0cc1c9d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/0cc1c9dad055b00eb7a7d77babfe8dfe2bd40ade))
* improve guard initializeWithCurrentNote when note is not yet available ([37a8852](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/37a8852d77562f2dd585717ee6f5b487f9ef9e9d))
* Incorrect Handling of One-Way Train Runs in Track Data Assignment ([#518](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/518)) ([844d351](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/844d351262c95d4d6cc1d072708b1edae2dabc4b))
* Issue fixed. Styling is now in scss no longer in the typescript ([#627](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/627)) ([93c0d27](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/93c0d27f0a5ed37b35ac0b100d6edfc131f0d3f6))
* **issue_template:** url in pr, issue and bug report template ([0be456d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/0be456db453ffc8d742ba0ac46cae37af56eb3e4))
* **json-files:** missing asymmetry, port-ordering and traffic-side migrations ([7d94c0a](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/7d94c0a372b4f9ba988554940527670bb02d4b47))
* just in case the update is faster then the deletion (close window) ([35d79c2](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/35d79c25becd19db42219d20055191fe4cf2c633))
* Lock symbol (svg) background rendering issue pearls view ([#704](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/704)) ([8c766e1](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/8c766e1e098e8b1a4a5e8fa53a5c98749b643419))
* **model:** initialize potential missing TrainrunSection.path ([03279fe](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/03279fee25eef01a28bb3f597691fa096f34c4c0))
* Mouse cursor issue fixed ([#662](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/662)) ([4ca8377](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/4ca8377c0ece96e377572031da39cc92d213b24e))
* Multiply filter change event (signal) triggers when filter panel gets shown  ([#610](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/610)) ([177e0ab](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/177e0abdc0a907d8b2e56fe2d0c29dcad3a329c7))
* Odd times for freq &gt; 60 will be italic rendering in the trainrun-section-card.component ([#865](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/865)) ([15ebe4a](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/15ebe4a38f1c31873ec51337aa70a14d6188ef67))
* One way train run arrows are drawn outside of lines when moving node ([#591](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/591)) ([ef671ff](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/ef671ff5a1816a30288f0897ab2f3bc8c2aa148b))
* **operation:** emit trainrun update on time propagation ([01d40b8](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/01d40b86697bb4dc4ff047f7c1aeef12095ac2c7))
* Origin-destination-view reset (init) fixed when filter, color , value changed ([#1113](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/1113)) ([0646eb7](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/0646eb7d5aa62191834cdf9cc76183d5535d4c50))
* Performance - only render trainrunSection and transition element - which are required ([#444](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/444)) ([4d2ba01](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/4d2ba01c3edfa556aa33ddc2f3eeb58a0c7c1476))
* Perlenkette Connection Time display precision fixed ([#863](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/863)) ([9bc89e4](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/9bc89e413ae93c2d74785a6a7e704a6a8cc72fa4))
* **perlenkette:** do not display asymmetry arrow when trainrun is one-way ([23fdd95](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/23fdd954ad4ad3e83a90657efa80188ed3ecb22a))
* Problem fixed and refactored some part. This refactoring fixes a… ([#594](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/594)) ([9acf684](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/9acf684e95dd8f12f9e49e0c6a897a43ed8b9e22))
* problem solved - design addapted to the left / right side-bar ([#639](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/639)) ([30fb09a](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/30fb09ad5b057c5569be844f50ef0b8fd95c669d))
* Release-please no with Trusted Publisher NPM ([#728](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/728)) ([42978ce](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/42978cebee21392f5c241cae10731b7c4ef777e0))
* remove undoService.pushCurrentVersion - call … ([#445](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/445)) ([8ba733d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/8ba733dd668a2cc546b41ccfc2c24ac7515e80f0))
* Reported issue fixed due of wrong halteZeit (stopping time logic) ([#949](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/949)) ([758dfd4](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/758dfd48e5430f160a320c6b774264f01d4d6d65))
* Reported minus/plus button issue resolved ([#864](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/864)) ([5eed8d2](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/5eed8d2a8fe8880402ca9364d7ec1beba202987a))
* reset main view after netzgrafikDto import ([c0e2d02](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/c0e2d0202e96d1097362b519e274e74c862213be))
* Reset state (subject) when closing the Editor/..View ([#647](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/647)) ([fda7342](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/fda7342e98b976796967796e5fa322545b58f7d5))
* Resource deletion when node gets deleted ([#523](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/523)) ([5d15e60](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/5d15e608ca88741635e0a0de3abbd8ccbd0d79b1))
* revert the order change (emit only at the very end) ([b8c7612](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/b8c7612ff0999106272fb447724ee6a344c17258))
* Roadmap link ([#512](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/512)) ([27e98ea](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/27e98eac923502f66dfd094c0c03e9febc8a31b8))
* Scale netzgrafik does not include notes ([#616](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/616)) ([240471b](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/240471b6652eb96e981dde1c76b3a80ba7e78987))
* Select all nodes/notes with `ctrl + a` no longer ignores active filters ([#766](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/766)) ([8684f4d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/8684f4d3faa4a9f81f8d82480ae08c8eb650516f))
* **service:** correctly instantiate TrainrunSection when coming from 3rd party ([a177ad4](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/a177ad4137d534adb614b8a487a844e88890c48e))
* **service:** fix travelTimeOffset for asymmetric trainruns ([7d35c86](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/7d35c86abe55ee982fcbcd10856ac6639d4d478b))
* **service:** missing  in trainrun updates ([d0b57af](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/d0b57af2464ad79f2cb802437687fc9afa3df934))
* **service:** missing initPortOrdering after node deletion ([1696825](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/16968258c3d8c0731911bfbdf72f9c70e169f592))
* **service:** missing initPortOrdering after trainrun deletion ([3c1b288](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/3c1b2880d5c3362bc6e3f36beacc4dc0eeb67a55))
* **service:** missing initPortOrdering after trainrun duplication ([3a71747](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/3a717475042cc8b8c53bb011d58cc3bcec1e0ab1))
* **service:** missing initPortOrdering after trainrunSection creation ([ca42cff](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/ca42cffc903867a5d688b4517c837776c2fba1ae))
* **service:** missing initPortOrdering after trainrunSection deletion ([00edded](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/00edded6e4ff5860e1b246602e32818043fb1e23))
* **service:** temporary fix for symmetry reset ([c54de5d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/c54de5d18ec372e57a4bf9cd8a5b8257acb34382))
* simplify OD matrices processing (performance) ([7d18cd5](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/7d18cd55aab0abf8796f7236bd8c3a90bf7ed9fa))
* simplify OD matrices processing (performance) ([e9d2e55](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/e9d2e55134ac12b0234c3039e7652db7a9df4b41))
* special case added (handled) ([#1033](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/1033)) ([a7ef5bf](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/a7ef5bf6c1f622d3299126160d2ef683c3c5b95d))
* spin-buttons issue resolved ([#996](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/996)) ([2a1da54](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/2a1da541ef78c34d2756896b439c441bb5e15a27))
* **streckengrafik:** add missing translation key ([1fd41e5](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/1fd41e5a0a2bdf249bfcb047dcf6828d9e4bcd6d))
* **streckengrafik:** bottom options overflow ([1cdf83f](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/1cdf83fc41f606dc4af9abd14af155202ef076c7))
* **streckengrafik:** correct arrival time for right-to-left ONE_WAY trains ([#786](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/786)) ([#787](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/787)) ([6f48b7d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/6f48b7df03031fb5ddd44c116d0796bc3ba82ccc))
* **streckengrafik:** fix turnaround time for asymmetric trainruns ([f9eb470](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/f9eb4704d7ea8a0a497f5fb4cf59ffad5e58651b))
* **streckengrafik:** use proper node for ONE_WAY extremity detection ([#764](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/764)) ([402b5ae](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/402b5ae6146dfea4d496e4ce305bc31f2d712b3f))
* Swap the O/D data ([#856](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/856)) ([049fdb5](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/049fdb552b0c7eb61b69edcfec29042c8aa22ba2))
* synch prosemirror-model versions in ngx-editor dependencies ([c4cf303](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/c4cf303002b829d9cb2ae8371762c6bbd0ec5534))
* The migration of the third-party import was not correctly performed during the one-way feature implementation. ([#620](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/620)) ([70b46e3](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/70b46e31ef4e48bff57c626d85671fde8718d24a))
* The performance gets improved for big Netzgrafik ([#427](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/427)) ([bb00a4d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/bb00a4d54cded069132d1bbf5b1e7e754af97288))
* There was an issue introduced during refactoring. The problem occurs when the user drags too quickly from left to right: the mouse suddenly leaves the dialog window and loses the drag content. This causes the dragging to get stuck and results in poor UX. ([#642](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/642)) ([5408a97](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/5408a97beb9ab85935e0bed2b8fa3a9f55c953d6))
* toggle temporay disable ([#455](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/455)) ([bdede87](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/bdede8730099a92669d4a741a229f8cdd56582cc))
* **traffic side:** fix unwanted overwrite ([f12257d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/f12257d0c4988603f2567e597d17b6746273a931))
* trainrun and trainrunSection (eg. times) update trigger redraw ([#1114](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/1114)) ([0106848](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/0106848f5c9152663b0fba0890b94a894ace2ef1))
* Trainrun deselection leaves single trainrun section marked/selected ([#682](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/682)) ([86f7120](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/86f712000a52e5c776663df52cf6935cbe16d286))
* **trainrun:** allows to change direction of cyclic one way trainrun ([a32cacc](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/a32cacc90e1f7675e38486ce4c5a23fb1fcd7596))
* **trainrun:** validate that travel time respect timePrecision ([b777e25](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/b777e25e24383c2f61ea9a91e8d4a48a697e025a))
* update some npm packages  ([#511](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/511)) ([b5caa7d](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/b5caa7d444613522d63139a753a6c3c704168c90))
* updateTrainrunCategory,      updateTrainrunTimeCategory and     … ([#457](https://github.com/aschantraine/netzgrafik-editor-frontend/issues/457)) ([ee9a0b7](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/ee9a0b7aecdc256784de0b128d5f322c9f2f295e))
* use getDto() in NGE events instead of models ([5b59eee](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/5b59eeeaeebe26ec42e230af69326350f4491d22))
* use HashLocationStrategy for standalone mode ([e8a155a](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/e8a155ae22578f793f1b325048574c805e097af6))
* **view:** apply border-radius change only to checkbox and not radio buttons ([161e035](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/161e03596824f4a6589d71493b0656c0e849d369))
* **view:** don't use attr() to set js executing attributes ([0b61263](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/0b61263dcb8e254613320bf1698a5e586c91a08f))
* **view:** hide one-way arrow around hidden nodes ([731f030](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/731f0303e70e3777ad27f8659fe0d6cee9dba6b7))
* We have to close the sbb-editor-node-detail-view before deleting the node. Just change the call-order. ([f0f6d7b](https://github.com/aschantraine/netzgrafik-editor-frontend/commit/f0f6d7b14bc5c9cefec7b9c98a8981685fda7979))
